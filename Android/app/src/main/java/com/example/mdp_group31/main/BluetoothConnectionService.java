...
public class BluetoothConnectionService {
    ...
    private class AcceptThread extends Thread{
        ...
        public AcceptThread() {
            ...
            try {
                tmp = mBluetoothAdapter.listenUsingRfcommWithServiceRecord(appName, myUUID);
                Log.d("acceptThread", "running accept thread");
            } catch (IOException e){
                e.printStackTrace();
            }
        ...
        public void run(){
            ...
            try {
                Log.d(TAG, "socket device ");
                socket = ServerSocket.accept();
                Log.d(TAG, "socket device "+socket.getRemoteDevice());
            } catch (IOException e){
                Log.d(TAG, "socket device connection error");
                e.printStackTrace();
            } catch (Exception e){
                Log.d(TAG, "socket device connection geneal error");
                e.printStackTrace();
            }

            // connection accepted
            if (socket != null){
                Log.d(TAG, "Getting remove device "+socket.getRemoteDevice());
    ...
    private class ConnectThread extends Thread{
        ...
        public void run(){
            ...
            try {
                mSocket = mDevice.createRfcommSocketToServiceRecord(deviceUUID);


            try {
                mSocket.connect();
                Log.d(TAG, "mSocket "+mSocket.isConnected()+" "+mSocket.toString());
