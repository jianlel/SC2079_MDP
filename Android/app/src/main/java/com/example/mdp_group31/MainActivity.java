...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton upBtn, downBtn, leftUpBtn, rightUpBtn, leftDownBtn, rightDownBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.btFragment = new BluetoothChatFragment();
        ...
        this.leftUpBtn = findViewById(R.id.leftUpBtn);
        this.rightUpBtn = findViewById(R.id.rightUpBtn);
        this.leftDownBtn = findViewById(R.id.leftDownBtn);
        this.rightDownBtn = findViewById(R.id.rightDownBtn);
     ...
     */
    public ImageButton getLeftUpBtn() {
        return this.leftUpBtn;
    }
     ...
     */
    public ImageButton getRightUpBtn() {
        return this.rightUpBtn;
    }
    public ImageButton getLeftDownBtn(){return this.leftDownBtn;}
    public ImageButton getRightDownBtn() {
        return this.rightDownBtn;
    }
    /**
    ...
    public void sendMessage(String message) {
        this.editor = this.sharedPreferences.edit();
        message += "\n";
        Log.d(TAG, "BluetoothConnectionService.BluetoothConnectionStatus "+BluetoothConnectionService.BluetoothConnectionStatus);
    ...
    public void printMessage(String message) {
        this.btFragment.getMessageReceivedTextView().append("SENT: " + message);
    }
    ...
    public void refreshCoordinate() {
        //Resetting coordinates starting from 0,0. Minus 1 here
        this.robotXCoordText.setText(String.valueOf(this.gridMap.getCurCoord()[0]-1));
        this.robotYCoordText.setText(String.valueOf(this.gridMap.getCurCoord()[1]-1));
        this.robotDirectionText.setText(this.sharedPreferences.getString("direction", ""));
    }
    ...
    BroadcastReceiver messageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d("receiving message", message);

            if(message!=null) {
                try{
                    JSONObject jsonObject = new JSONObject(message);
                    if("status".equals(jsonObject.getString("cat"))){
                        robotStatusText.setText(jsonObject.getString("value"));
                    }
                    else if("location".equals(jsonObject.getString("cat"))){
                        robotStatusText.setText(jsonObject.getString("value"));
                        JSONObject locValue = new JSONObject(jsonObject.getString("value"));
                        int xPos = locValue.getInt("x");
                        int yPos = locValue.getInt("y");
                        double bearing = locValue.getDouble("d");
                        gridMap.moveRobot(new int[]{xPos, yPos}, bearing);
                        robotXCoordText.setText(String.valueOf(xPos));
                        robotYCoordText.setText(String.valueOf(yPos));
//                        robotDirectionText.setText();
                    }
                    else if("target".equals(jsonObject.getString("cat"))){
                        JSONObject obsValue = new JSONObject(jsonObject.getString("value"));
//                        robotStatusText.setText(jsonObject.getString("value"));
                        gridMap.updateImageID(String.valueOf(obsValue.getInt("obstacle id")), String.valueOf(obsValue.getInt("image id")));
                    }
            ...
            if (message.contains("IMG")) { // update obstacle id
